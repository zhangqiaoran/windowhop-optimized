...
for fi in range(FRAME_COUNT):
    ...
    d.text((918,80), "v3.4.7", font=F_MED, fill=(245,249,255,255))
...
hd.text((912, 251), "Latest v3.4.7", font=F_BODY, fill=(244, 248, 255, 255))
...
hd = ImageDraw.Draw(hero)
hd.text((95, 324), "↓  Download Latest v3.4.7", font=F_CARD, fill=(255,255,255,255))
...
steps = [
    ("1", "Download 3.4.7", "Get the latest release"),
